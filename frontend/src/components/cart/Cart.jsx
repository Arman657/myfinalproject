...
const Cart = ({setOpenCart}) => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10'>
        <div className='fixed top-0 right-0 min-h-full 800px:w-[25%] w-[80%] bg-white flex flex-col justify-between shadow-sm'>
                {
                    cart && cart.length === 0 ? (
    ...
    return (
        <div className='border-b p-4'>
            <div className='w-full flex items-center'>
                ...
                <img src={`${data.images && data.images[0]?.url}`} alt="" className='w-[130px] h-min mr-2 rounded-[5px] ml-2'/>
                ...
                <RxCross1 className='cursor-pointer w-[25px] h-[25px]' onClick={()=>removeFromCartHandler(data)}/>
