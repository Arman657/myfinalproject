...
const Signup = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
        ...
        <div className="mt-8 sm:mx-auto sm:max-w-md md:w-[60vw] lg:w-[70vw]">
            <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 '>
                <form className="space-y-6" onSubmit={handlerSubmit}>
                    <div>
                        ...
                        <div className='mt-1'>
                            <input type="text" name='text' autoComplete='name' required value={name} onChange={(e)=>setName(e.target.value)} className='appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm'/>
                    ...
                    <div>
                        ...
                        <div className='mt-2 flex items-center'>
                            ...
                            <label htmlFor="file-input" className='ml-5 flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50'>
                                <span>Upload a file</span>
                                <input type="file" name='avatar' id='file-input' accept='.jpg,.jpeg,.png' className='sr-only' onChange={handlerFileInputChange} />
                            </label>
                        </div>
                    </div>
