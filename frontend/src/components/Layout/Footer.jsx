    ...
    <div className='bg-[#000] text-white'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 sm:text-center'>
            <ul className='px-5 text-center sm:text-start flex sm:block flex-col items-center'>
                <img src="whitelogo.png"  alt="" style={{filter:"brightness(0) invert(1)"}} className='h-14'/>

                <br />
                <p>The home and elements needed to create beatiful products.</p>
                <div className='flex items-center mt-[15px]'>
                    <AiFillFacebook size={25} className='cursor-pointer'/>
                    <AiOutlineTwitter size={25} style={{marginLeft:"15px", cursor:"pointor"}}/>
                    <AiFillInstagram size={25} style={{marginLeft:"15px", cursor:"pointor"}}/>
                    <AiFillYoutube size={25} style={{marginLeft:"15px", cursor:"pointor"}}/>
                </div>
            </ul>
