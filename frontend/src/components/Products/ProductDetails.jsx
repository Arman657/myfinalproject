                ...
                <div className={`${styles.section} w-[90%] 800px:w-[80%]`}>
                    <div className='w-full py-5'>
                        <div className="block w-full 800px:flex">
                                ...
                                <img src={`${data.images && data.images[select]?.url}`} alt="" className='800px:w-[90%] w-[100%]'/>

                                <div className='800px:w-full 800px:flex grid grid-cols-2'>
                               {
                                data && data.images.map((i,index)=>(
                                    <div className={`${select === 0 ? "border" : "null"} cursor-pointer`}>
                                    <img src={`${i.url}`} alt="" className='800px:h-[180px] 800px:overflow-hidden 800px:mr-3 800px:mt-3 800px:w-[180px] h-[180px] w-[180px] overflow-hidden mr-3 mt-3' onClick={()=>setSelect(index)}/>
                            ...
                            <div className={`${styles.button} !mt-5 !rounded !h-11 flex items-center`} onClick={() => addToCartHandler(data._id)}>
                            ...
                            <div className="flex items-center pt-8 ">
                               ...
                               <img src={`${data?.shop?.avatar.url}`} alt="" className='w-[50px] h-[50px] rounded-full mr-2 border-[0.01px] border-solid border-black'/>
                               </Link>
                    ...
                    <div className='w-full block 800px:flex p-5'>
                        <div className='w-full 800px:w-[50%]'>
                           ...
                           <div className='flex items-center'>
                                <img src={`${data?.shop?.avatar.url}`} alt="" className='w-[50px] mt-2 h-[50px] rounded-full border-solid border-[0.1px] border-black' />
                                    <div className='pl-3'>
